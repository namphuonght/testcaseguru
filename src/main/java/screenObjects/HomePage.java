...
public class HomePage extends CommonPage {
    ...
    public Withdrawalpage ClickLinkWithdrawal() {
        try {
            getHelper().waitForControlVisible(homePageElement.ele_link_menu_manager);
            getHelper().findElement(homePageElement.ele_link_menu_with_drawal).click();
        } catch (Exception e) {
            Result.checkFail("Class HomePage | Method ClickLinkWithdraw | Exception desc : " + e.getMessage());
        }
        return new Withdrawalpage(driver);
    }
    public Withdrawalpage ClickLinkFundTransfer() {
        try {
            getHelper().waitForControlVisible(homePageElement.ele_link_menu_manager);
            getHelper().findElement(homePageElement.ele_link_menu_fund_transfer).click();
        } catch (Exception e) {
            Result.checkFail("Class HomePage | Method ClickLinkWithdraw | Exception desc : " + e.getMessage());
        }
        return new Withdrawalpage(driver);
