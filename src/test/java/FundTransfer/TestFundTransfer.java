...
public class TestFundTransfer extends BaseTest {
    ...
    public void TC005_AddNewDepositSuccessfully() throws InterruptedException {
        ...
        homePage.ClickLinkFundTransfer();

        withdrawalpage.VerifyWithdrawalpageAllElements();
        withdrawalpage.TheWithdrawalFormTitleShouldBe("Fund transfer");
    ...
    @Test
    public void TC006_AddNewDepositSuccessfully() throws InterruptedException {
        testCaseName = new Object() {
        }.getClass().getEnclosingMethod().getName();
        super.startRecordVideoAfterMethod(className, testCaseName);
